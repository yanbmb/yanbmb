...
class App(customtkinter.CTk): #criação da interface do sistema.
    def __init__(self):
        ...
        self.radio_button_1 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="Micron Participações", variable=self.varfrm1, value='emp1')
        self.radio_button_1.grid(row=2, column=1, pady=10, padx=20, sticky="")
        self.radio_button_2 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="Micron Serviços", variable=self.varfrm1, value='emp2')
        ...
        self.radio_button_3 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="Micron Participações", variable=self.varfrm2, value='emp1')
        self.radio_button_3.grid(row=5, column=1, pady=10, padx=20, sticky="")
        self.radio_button_4 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="Márcio Dias Campos", variable=self.varfrm2, value='soc1')
        self.radio_button_4.grid(row=6, column=1, pady=10, padx=20, sticky="")
        self.radio_button_5 = customtkinter.CTkRadioButton(master=self.radiobutton_frame, text="Geziel Gomes de Freitas", variable=self.varfrm2, value='soc2')
