...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title('RotinasCTB')
        self.geometry(f"{920}x{480}")
        ...
        self.frame01 = customtkinter.CTkFrame(self, width=160, corner_radius=10)
        self.frame01.grid(row=0, column=0, rowspan=4, sticky='nsew', padx=10, pady=10)
        self.label_frame01 = customtkinter.CTkLabel(self.frame01, text='Extrator NF3E',
                                                    font=customtkinter.CTkFont(size=20, weight='bold'))
        self.label_frame01.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.button01_frame01 = customtkinter.CTkButton(self.frame01, text='EDP', command=self.extrairEDP)
        self.button01_frame01.grid(row=1, column=0, padx=20, pady=20)
        self.button02_frame01 = customtkinter.CTkButton(self.frame01, text='ENERGISA', command=self.extrairENERG)
        self.button02_frame01.grid(row=2, column=0, padx=20, pady=20)
        self.button03_frame01 = customtkinter.CTkButton(self.frame01, text='CEMIG', command=self.extrairCEMIG)
        self.button03_frame01.grid(row=3, column=0, padx=20, pady=20)

        self.frame02 = customtkinter.CTkFrame(self, width=540, corner_radius=10)
        self.frame02.grid(row=0, column=1, rowspan=4, sticky='nsew', pady=10)
        self.label_frame02 = customtkinter.CTkLabel(self.frame02, text='Emissor recibos',
                                                    font=customtkinter.CTkFont(size=20, weight='bold'))
        self.label_frame02.grid(row=0, column=2, padx=10, pady=(20, 10))

        self.valor_radio01 = tkinter.StringVar(value='')

        self.label_radio01 = customtkinter.CTkLabel(master=self.frame02, text='Marque o pagador:',
                                                    font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_radio01.grid(row=1, column=1, columnspan=1, padx=(10, 0), pady=(10, 0), sticky='')
        self.radio01_button01 = customtkinter.CTkRadioButton(master=self.frame02, text='Empresa teste 1',
                                                             variable=self.valor_radio01, value='emp1')
        self.radio01_button01.grid(row=2, column=1, padx=(10, 0), pady=(10, 0), sticky='nsew')
        self.radio01_button02 = customtkinter.CTkRadioButton(master=self.frame02, text='Empresa teste 2',
                                                             variable=self.valor_radio01, value='emp2')
        self.radio01_button02.grid(row=3, column=1, padx=(10, 0), pady=(10, 0), sticky='nsew')

        self.valor_radio02 = tkinter.StringVar(value='')

        self.label_radio02 = customtkinter.CTkLabel(master=self.frame02, text='Marque o recebedor:',
                                                    font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_radio02.grid(row=4, column=1, columnspan=1, padx=(10, 0), pady=(20, 0), sticky='')
        self.radio02_button01 = customtkinter.CTkRadioButton(master=self.frame02, text='Empresa teste 1',
                                                             variable=self.valor_radio02, value='emp1')
        self.radio02_button01.grid(row=5, column=1, padx=(10, 0), pady=(10, 0), sticky='nsew')
        self.radio02_button02 = customtkinter.CTkRadioButton(master=self.frame02, text='Sócio teste 1',
                                                             variable=self.valor_radio02, value='soc1')
        self.radio02_button02.grid(row=6, column=1, padx=(10, 0), pady=(10, 0), sticky='nsew')
        self.radio02_button03 = customtkinter.CTkRadioButton(master=self.frame02, text='Sócio teste 2',
                                                             variable=self.valor_radio02, value='soc2')
        self.radio02_button03.grid(row=7, column=1, padx=(10, 0), pady=(10, 0), sticky='nsew')

        self.valor_radio03 = tkinter.StringVar(value='')

        self.label_radio03 = customtkinter.CTkLabel(master=self.frame02, text='Será um adiantamento?',
                                                    font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_radio03.grid(row=1, column=3, columnspan=1, padx=(0, 10), sticky='')
        self.radio03_button01 = customtkinter.CTkRadioButton(master=self.frame02, text='Sim',
                                                             variable=self.valor_radio03, value='S')
        self.radio03_button01.grid(row=2, column=3, padx=(0, 10), sticky='')
        self.radio03_button02 = customtkinter.CTkRadioButton(master=self.frame02, text='Não',
                                                             variable=self.valor_radio03, value='N')
        self.radio03_button02.grid(row=3, column=3, padx=(0, 10), sticky='')

        self.label_valor01 = customtkinter.CTkLabel(master=self.frame02, text='Valor:',
                                                    font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_valor01.grid(row=4, column=3, columnspan=1, padx=(0, 10), sticky='nsew')
        self.entry_valor01 = customtkinter.CTkEntry(self.frame02, placeholder_text='Valor no formato: 1500.50')
        self.entry_valor01.grid(row=5, column=3, padx=(0, 10), sticky='nsew')

        self.label_data01 = customtkinter.CTkLabel(master=self.frame02, text='Data:',
                                                   font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_data01.grid(row=6, column=3, columnspan=1, padx=(0, 10), sticky='nsew')
        self.entry_data01 = customtkinter.CTkEntry(self.frame02, placeholder_text='Data no formato: 310323')
        self.entry_data01.grid(row=7, column=3, padx=(0, 10), sticky='nsew')
        self.label_espaco01 = customtkinter.CTkLabel(master=self.frame02, text='\n')
        self.label_espaco01.grid(row=8, column=3, sticky='nsew')
        self.button_gerar01 = customtkinter.CTkButton(self.frame02, text='Gerar', command=self.gerar)
        self.button_gerar01.grid(row=9, column=2, padx=10, pady=10)

        self.frame03 = customtkinter.CTkFrame(self, width=160, corner_radius=10)
        self.frame03.grid(row=0, column=4, rowspan=4, sticky='nsew', padx=10, pady=10)
        self.label_pgtos = customtkinter.CTkLabel(master=self.frame03, text='Extrator de pgtos',
                                                  font=customtkinter.CTkFont(size=20, weight='bold'))
        self.label_pgtos.grid(row=0, column=1, columnspan=1, padx=10, pady=(20, 10), sticky='nsew')

        self.label_data02 = customtkinter.CTkLabel(master=self.frame03, text='Data do pagamento:',
                                                   font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_data02.grid(row=1, column=1, columnspan=1, padx=10, pady=10, sticky='')
        self.entry_data02 = customtkinter.CTkEntry(self.frame03, placeholder_text='Data no formato: 310323')
        self.entry_data02.grid(row=2, column=1, padx=10, sticky='nsew')

        self.label_ref = customtkinter.CTkLabel(master=self.frame03, text='Mês de referência:',
                                                font=customtkinter.CTkFont(size=14, weight='bold'))
        self.label_ref.grid(row=3, column=1, columnspan=1, padx=10, pady=10, sticky='')
        self.entry_ref = customtkinter.CTkEntry(self.frame03, placeholder_text='Mês no formato: 032023')
        self.entry_ref.grid(row=4, column=1, padx=10, sticky='nsew')
        self.label_espaco02 = customtkinter.CTkLabel(master=self.frame03, text="\n")
        self.label_espaco02.grid(row=5, column=1, sticky='nsew')
        self.label_espaco03 = customtkinter.CTkLabel(master=self.frame03, text="\n")
        self.label_espaco03.grid(row=6, column=1, sticky='nsew')
        self.button_gerar02 = customtkinter.CTkButton(self.frame03, text='Buscar e Gerar', command=self.pgtos)
        self.button_gerar02.grid(row=7, column=1, padx=10)
        self.label_espaco04 = customtkinter.CTkLabel(master=self.frame03, text="\n")
        self.label_espaco04.grid(row=8, column=1, sticky='nsew')
        self.label_espaco05 = customtkinter.CTkLabel(master=self.frame03, text="\n")
        self.label_espaco05.grid(row=9, column=1, sticky='nsew')
        self.label_espaco06 = customtkinter.CTkLabel(master=self.frame03, text="\n")
        self.label_espaco06.grid(row=10, column=1, sticky='nsew')

        self.button_sair = customtkinter.CTkButton(master=self.frame03, fg_color='transparent', border_width=2,
                                                   text='Sair', text_color=('gray10', '#DCE4EE'), command=self.close)
        self.button_sair.grid(row=11, column=1, padx=20, pady=20, sticky='nsew')
    ...
    def gerar(self): #emissor de recibos
        try:
            ...
            mes = ''
            pessoa = ''
            pg = self.valor_radio01.get() #vai buscar a opção do pagador marcada no radio button.
            rec = self.valor_radio02.get() #vai buscar a opção do recebedor marcada no radio button.
            ad = self.valor_radio03.get() #vai buscar a opção de adiantamento marcada no radio button.
            vr = float(self.entry_valor01.get()) #vai buscar o valor digitado no entry.
            if self.entry_data01.get() == '': #caso nao informar a data no entry, ele seta a data como nenhum, para não da erro na busca e sim na criação do pdf.
                dt = None
            else:
                dt = self.entry_data01.get() #vai buscar o valor informado no entry para a data.
    ...
    def pgtos(self): #extrator de pagamentos
        try:
            buscar = askopenfilename()
            data = self.entry_data02.get()
            mes = self.entry_ref.get()
                ...
                for pagina in pdf:         #esse é um relatório específico emitido no sistema Alterdata, módulo do departamento pessoal.
                    ...
                    if ini != -1:
                        ...
                        for funcionarios in range(0, 42): #aqui ele vai percorrer os demais nomes em cada página (são 42 nomes após o 1º em cada página no relatório)
                            ...
                            finVR = texto.find(',', iniVR)
                            valor = texto[iniVR:finVR + 3].strip()
                            if nome == 'NOME SÓCIO': #aqui é uma condição de uma nome específico pois ele é sócio e não funcionário, então o codigo do lançamento muda de 00631 para 00471.
                                arquivo.write(f'"00471"; ""; ""; "{data[0:2]}/{data[2:4]}/{data[4:6]}"; "{valor}"; "1001"; "{nome} REF. {mes[0:2]}/{mes[2:6]}"\n')
                            if nome == 'NOME AUTONOMO': #aqui é uma condição de uma nome específico pois ele é autonomo e não funcionário, então o codigo do lançamento muda de 00631 para 00682.
